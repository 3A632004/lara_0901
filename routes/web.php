...
Route::group(['prefix' => 'admin'], function() {
    ...
    Route::patch('posts/{id}'   , ['as' => 'admin.posts.update', 'uses' => 'AdminPostController@update']);
    Route::delete('post/{id}'   , ['as' => 'admin.posts.destroy', 'uses' => 'AdminPostsController@destroy']);
});
